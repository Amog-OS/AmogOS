Getting started:
This release contains a iso and a zip. 
For installation, you can choose the fast method via the iso, or use the zip for manual installation if you are using a CD, if the fast method won't work, or if you are using a Linux PC.
...
Find "AmogOS" at the top of the "Other Distros" section in Universal USB Installer, choose your spare USB stick (reccomended size > 2GB), download & choose the ISO in the release and click Create.

Manual installation:
Download & extract the .zip and follow the instructions in the "AmogOS-Manual-Install.txt" file inside it to install the OS onto a spare USB stick.
